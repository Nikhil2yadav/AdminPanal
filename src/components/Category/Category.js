...
import './Category.css'; // Import custom CSS file
...
import Categoryfrom from './Categoryfrom'; // Import CategoryForm component
...
const Category = () => {
  ...
  const handleFormSubmit = (formData) => {
    ...
    setUsersData([...usersData, newCategory]);
    setOpenPopup(false);
  ...
  return (
    <div className='content-wrapper'>
        ...
        <div className="container-fluid">
          <div className="row mb-2">
            <div className="col-sm-6">
              <h1 className="m-0 text-dark">Manage <small>Category</small></h1>
            </div>
            <div className="col-sm-6">
      ...
      <button className="btn btn-primary" onClick={() => setOpenPopup(true)} id='adduser'>Add Category</button>

      <div className="card">
        <h5 className="card-header">Manage Category</h5>
        <div className='card-body'>
          ...
          <table className=' table-bordered table table-striped' id='table'>
            <thead>
              <tr>
                <th onClick={() => handleSort('categoryname')} id='Myusername'>
                  Category name
                  {sortColumn === 'categoryname' && (sortDirection === 'asc' ? <FaSortAlphaDown /> : <FaSortAlphaUp />)}
                </th>
      ...
      >
        <Categoryfrom onSubmit={handleFormSubmit} onClose={handleClose}/>
      </Popup>
    </div>
  );
};
