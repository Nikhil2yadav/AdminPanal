...
const Managegroup = () => {
  ...
  const startEditUser = (user) => {
    setEditUser(user); // Open the popup for editing
  };
  ...
  const handleFormSubmit = (formData) => {
    ...
    setUsersData([...usersData, newGroup]);
  ...
  return (
    <div className='content-wrapper'>
        ...
        <div className="container-fluid">
          <div className="row mb-2">
            <div className="col-sm-6">
              <h1 className="m-0 text-dark">Manage <small>Group</small></h1>
            </div>
            <div className="col-sm-6">
      ...
      <a className="btn btn-primary" href='' id='adduser'>Add Group</a>

      <div className="card">
        <h5 className="card-header">Manage Groups</h5>
        <div className='card-body'>
          ...
          <table className='table-bordered table table-striped' id='table'>
            <thead>
              <tr>
                <th onClick={() => handleSort('groupname')} id='Myusername'>
                  Group name
                  {sortColumn === 'groupname' && (sortDirection === 'asc' ? <FaSortAlphaDown /> : <FaSortAlphaUp />)}
                </th>
